...
class Cityscapes(BaseDataset):
    def __init__(self, config, mode):
        ...
        ignore_label = config_data.IGNORE_LABEL
        num_samples = config_data.NUM_SAMPLES

        super(Cityscapes, self).__init__(config, ignore_label,
                                         base_size=config_data.BASE_SIZE,
                                         crop_size=(config_data.IMAGE_SIZE[1], config_data.IMAGE_SIZE[0]),
                                         downsample_rate=config_data.DOWNSAMPLERATE,
        ...
        self.multi_scale = config_data.MULTI_SCALE
        self.flip = config_data.FLIP
